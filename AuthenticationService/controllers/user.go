...
func (uc *UserController) CreateUser(w http.ResponseWriter, r *http.Request) {
	payload := r.Context().Value("payload").(dto.CreateUserRequestDTO)  // Extract the payload from the request context and assert it to the correct type , .(dto.CreateUserRequestDTO) is used to assert the type of the payload
...
func (uc *UserController) LoginUser(w http.ResponseWriter, r *http.Request) {
	...
	payload := r.Context().Value("payload").(dto.LoginUserRequestDTO) // Extract the payload from the request context
